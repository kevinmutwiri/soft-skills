...
Essentially, this framework is a set of logical and iterative steps that, when followed appropriately, support you in your data analysis.
...
Remember, just like any other bit of information in the world, data can be manipulated. So it is key to obtain data from a reliable source. We will learn more about how to tell whether a given dataset is legit or not.
